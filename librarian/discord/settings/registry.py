...
class Registry:
    ...
    def __init__(self, helper):
        ...
        self.__cache = collections.defaultdict(default_factory=self.default_settings)
        self.helper = helper
    ...
    def wrap(self, tokens):
        ...
        for k, v in zip(
            itertools.islice(tokens, 0, step=2),
            itertools.islice(tokens, 1, step=2)
        ):
            try:
                wrapper = self.KNOWN_SETTINGS[k]
